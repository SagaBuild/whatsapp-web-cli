...
Tests use synthetic browser data in ignored `.work/` directories and isolated CLI registries/profiles. Never point tests at a personal `WA_DATA_DIR`. CI must not contain account secrets or upload browser snapshots, traces or profiles.
